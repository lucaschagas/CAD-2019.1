...
int main(int argc,char *argv[]){
    ...
    #pragma omp parallel for num_threads(16) private(i_matriz,j_matriz) shared(matriz)
    ...
    //#pragma omp parallel for num_threads(1) private(i_vetor) shared(vetor)
    ...
    #pragma omp parallel for num_threads(12) private(i_linha, j_linha) shared(matriz,vetor,resultado)
	...
	*/
    ...
    #pragma omp parallel for num_threads(1) private(i_coluna, j_coluna) shared(resultado)
